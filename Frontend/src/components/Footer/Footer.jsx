		...
		<>
			<footer className={classes["padding_4x"]}>
				<div className={classes.flex}>
					<section className={classes["flex-content"] + " " + classes["padding_1x"]}>
						<h3>Top Products</h3>
					...
					<section className={classes["flex-content"] + " " + classes["padding_1x"]}>
						...
						<fieldset className={classes["fixed_flex"]}>
							...
							/>
							<button className={classes["btn"] + " " + classes["btn_2"]}>Subscribe</button>
						</fieldset>
					</section>
				</div>
				<div className={classes.flex}>
					...
					<section className={classes["flex-content"]  + " " + classes["padding_1x"]}>
						...
						<a href="#">
							<i className={classes.fa + " " + classes["fa-dribbble"]}></i>
						</a>
						<a href="#">
							<i className={classes.fa + " " + classes["fa-linkedin"]}></i>
						</a>
					</section>
				</div>
			</footer>
